...
/**
 * Created by Litao-pc on 2016/9/5.
 */
...
public class IOUtils {
    ...
    //删除查询到的id
    public void deleGetFormId(SQLiteOpenHelper helper, long idl, String tableName) {
        SQLiteDatabase database = helper.getWritableDatabase();
        database.beginTransaction();
        String[] agrs = {String.valueOf(idl)};
        database.delete(tableName, "catsic_map_id=?", agrs);
