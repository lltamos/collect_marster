...
public class CommonUtils {
     ...
     * @param showAnimation
     */
    public static void toActivity(Activity context, final Intent intent, final int requestCode, final boolean showAnimation) {
        ...
        context.runOnUiThread(() -> {
            ...
            if (showAnimation) {
                context.overridePendingTransition(R.anim.right_push_in, R.anim.left_push_out);
...
//    // 关闭activity
//    public static void finishActivity(Activity context, final boolean showAnimation) {
//        if (context == null) {
//            return;
//        }
//
...
//
//            if (showAnimation) {
//                context.overridePendingTransition(R.anim.fade, R.anim.right_push_out);
//            } else {
//                context.overridePendingTransition(R.anim.null_anim, R.anim.null_anim);
//            }
//
...
//    }
    ...
    public static String savePhotoToSDCard(String path, String photoName, String formSuffix, Bitmap photoBitmap) {
        if (photoBitmap == null || StringUtils.isNotEmpty(path, true) == false
                || StringUtils.isNotEmpty(StringUtils.isNotEmpty(photoName, true)
                + StringUtils.trim(formSuffix), true) == false) {
