...
// * <br/>************************************************
// */
//public abstract class OrmDaoSupport<T> {
//
...
//
//
//    public OrmDaoSupport(Class cls) {
//        try {
//            if (mHelper == null) {
//                mHelper = getHelper();
//            }
...
//    /**
//     * 查询，条件查询
//     * <br/> 说明： 该方法要和 {@link OrmDaoSupport#query(QueryBuilder)} 方法组合使用
//     * <br/> 在查询操作中，查询的条件最后都要 通过 {@link OrmDaoSupport#query(QueryBuilder)} 方法执行查询
...
//     * @throws SQLException
//     */
//    public QueryBuilder queryBuilder(Maps<String, Object> whereMap) throws SQLException {
//
...
//     * @throws SQLException
//     */
//    public int update(Maps<String, Object> whereMap, String columnName, Object columnValue) throws SQLException {
//        Maps<String, Object> updateValue = new HashMap<String, Object>();
...
//     * @throws SQLException
//     */
//    public int update(Maps<String, Object> whereMap, Maps<String, Object> updateValue) throws SQLException {
