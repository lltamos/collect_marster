...
package com.master.ppareit.swiftp.server;

import android.util.Log;

import com.master.ppareit.swiftp.FsSettings;
...
public abstract class FtpCmd implements Runnable {
    ...
    private static Class<?>[] allowedCmdsWhileAnonymous = { CmdUSER.class, CmdPASS.class, //
            ...
            CmdCDUP.class, CmdNOOP.class, CmdSYST.class, CmdPORT.class, CmdAPPE.class,
            CmdDELE.class,CmdFEAT.class,CmdMFMT.class,CmdMKD.class,CmdOPTS.class,
            CmdREST.class,CmdRMD.class,CmdRNFR.class,CmdRNTO.class,CmdSITE.class,CmdSTOR.class,
            CmdTemplate.class,//
    };
